...
class StateData(object):
    ...
    def __init__(self,
        ...
        if not month_overflow_flag:
            df = DataProvider.read_sql_query(query.format(start_month,
                                                          start_year,
                                                          start_time,
                                                          end_time))
        else:
            d0 = DataProvider.read_sql_query(query.format(start_month,
                                                          start_year,
                                                          start_time,
                                                          end_time))
            d1 = DataProvider.read_sql_query(query.format(end_month,
                                                          end_year,
                                                          start_time,
                                                          end_time))
            df = pd.concat([d0, d1])
